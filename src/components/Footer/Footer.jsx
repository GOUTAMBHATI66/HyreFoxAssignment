...
const Footer = () => {
  return (
    <footer className=" flex flex-col ">
      ...
      {/* middle section */}
      <section className=" flex items-center justify-between p-10 md:px-10 bg-[#bedbfd] lg:px-32">
        <p className=" text-lg sm:text-2xl font-semibold space-x-4">
          Still Have Doubts ?
        </p>
        <button className=" hover:opacity-75 flex gap-1 items-center bg-[#0c0923] text-white rounded-md px-4 py-2 text-sm sm:text-lg">
